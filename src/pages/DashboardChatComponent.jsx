...
function DashboardChatComponent() {
  ...
  return (
    <>
      <div className="p-10 mx-5 border shadow-md border-gray-300">
        <div className="flex align-middle justify-between text-black">
          <h2 className="text-2xl font-bold">Last Chat session</h2>
          <Link
            to="/Session-Earning"
            className="px-[15px] py-[10px] text-sm bg-black text-white font-medium rounded-md cursor-pointer"
          >
            View All
          </Link>
        </div>
...
export default DashboardChatComponent;
